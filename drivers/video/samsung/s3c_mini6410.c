...
/////////////////    ADD BY WEI    //////////////////
#elif defined(CONFIG_FB_S3C_EXT_T320240)
#define S3CFB_LCD_TYPE	"MY35"
#define S3CFB_VBP		(0x03)	/* back porch */
#define S3CFB_VFP		(0x01)	/* front porch */
#define S3CFB_VSW		(0x01)	/* vsync width */
#define S3CFB_HBP		(0x25)	/* back porch */
#define S3CFB_HFP		(0x10)	/* front porch */
#define S3CFB_HSW		(0x03)	/* hsync width */

#define S3CFB_HRES		320	/* horizon pixel  x resolition */
#define S3CFB_VRES		240	/* line cnt       y resolution */
#define S3CFB_VIDCON1	(S3C_VIDCON1_IVCLK_RISE_EDGE | S3C_VIDCON1_IVSYNC_INVERT | S3C_VIDCON1_IHSYNC_INVERT | S3C_VIDCON1_IVDEN_INVERT)
